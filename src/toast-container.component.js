System.register(['@angular/core', './toast-options'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            ToastContainer = (function () {
                ...
                ToastContainer.prototype.dismiss = function (toast) {
                    localStorage.setItem("sysNotification", localStorage.getItem("sysNotification") + "|"+toast.uniqueid);
